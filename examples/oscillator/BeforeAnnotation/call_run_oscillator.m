...
current_dir = pwd();
copyfile("../../../results/oscillator/BeforeAnnotation/oscillator_64.slx", current_dir);

outputTrace_path =  "../../../results/oscillator/BeforeAnnotation/testData_Output";
...
for test_id = 1 : total_test_trace
    fileName = "oscillator_" + num2str(test_id) + ".csv"; % testing trace file
