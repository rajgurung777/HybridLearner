...
current_dir = pwd();
copyfile("../../../results/twoTanks/AfterAnnotation/twoTanks_64_Type.slx", current_dir);

outputTrace_path =  "../../../results/twoTanks/AfterAnnotation/testData_Output";
...
close_system('twoTanks_64_Type', 0);
