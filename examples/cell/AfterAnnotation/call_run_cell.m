...
current_dir = pwd();
copyfile("../../../results/cell/AfterAnnotation/cellModel_64_Type.slx", current_dir);

outputTrace_path =  "../../../results/cell/AfterAnnotation/testData_Output";
...
close_system('cellModel_64_Type', 0);
