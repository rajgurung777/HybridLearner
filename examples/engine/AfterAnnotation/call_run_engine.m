...
current_dir = pwd();
copyfile("../../../results/engine/AfterAnnotation/engineTiming_64_Type.slx", current_dir);

outputTrace_path =  "../../../results/engine/AfterAnnotation/testData_Output";
...
close_system('engineTiming_64_Type', 0);
