...
%        (8) ver 1.1: enhanced redundancy checks, July 2005am am 
...
[k,v2] = convhulln([D;zeros(1,size(D,2))]);  % [k,v2] = convhulln([D;zeros(1,size(D,2))]);
[k,v1] = convhulln(D);
if v2 > v1
...
[null,I]=unique(num2str(V,6),'rows');  % [null,I]=unique(num2str(V,6),'rows'); 
